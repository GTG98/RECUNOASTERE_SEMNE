...
Usage:
# Create train data:
python3 xml_to_csv.py -i RECUNOASTERE_SEMNE/data/images/train -o RECUNOASTERE_SEMNE/data/images/annotations/train_labels.csv -l RECUNOASTERE_SEMNE/data/images/annotations
